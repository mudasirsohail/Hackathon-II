          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
                ...
                <Link
                  href="/demo"
                  className="inline-flex items-center px-8 py-4 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10 shadow hover:shadow-md transition-all duration-300"
                >
                  View demo
                </Link>
              </div>
